...
use Drupal\custom_entity\FooInterface;
use Drupal\user\UserInterface;


/**
 * Defines the FooEntity entity.
 *
 ...
 *   The view can be manipulated by using the standard Drupal tools in the
 *   settings.
 *
 ...
 *       "delete" = "Drupal\custom_entity\Form\FooDeleteForm",
 *     },
 *     "access" = "Drupal\custom_entity\FooAccessControlHandler",
 *   },
 *   list_cache_contexts = { "user" },
 *   base_table = "foo_entity",
 *   admin_permission = "administer foo entity",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 *     "uuid" = "uuid"
 ...
 *
 * Example: 'entity.custom_entity_foo.canonical'.
 *
 * See the routing file at foo.routing.yml for the
 * corresponding implementation.
 *
 * The Foo class defines methods and fields for the foo entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see FooInterface) also exposes the EntityOwnerInterface.
 ...
 */
class Foo extends ContentEntityBase implements FooInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Foo entity.'))
      ->setReadOnly(TRUE);

    // Standard field, unique outside of the scope of the current project.
    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the Foo entity.'))
      ->setReadOnly(TRUE);

    // Name field for the Foo.
    ...
    $fields['langcode'] = BaseFieldDefinition::create('language')
      ...
      ->setDescription(t('The language code of Foo entity.'));
